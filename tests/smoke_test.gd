...
func _run() -> void:
	...
	await physics_frame
	await physics_frame
	if player_sprite.frame_coords.y != 0 or player_sprite.position.y != -112.0 or player_sprite.scale != Vector2(1.76, 1.76):
	...
	if player_sprite.texture.resource_path != "res://assets/characters/player_male_crouch/sheet-transparent.png":
		...
		return
	if player_sprite.scale != Vector2(1.76, 1.76):
	...
	await physics_frame
	if player_sprite.texture.resource_path != "res://assets/characters/player_male_idle_relaxed/sheet-transparent.png" or player_sprite.scale != Vector2(1.76, 1.76):
	...
	player._active_animation = ""
	await physics_frame
	if player_sprite.texture.resource_path != "res://assets/characters/player_male_idle_sit/sheet-transparent.png" or player_sprite.scale != Vector2(1.76, 1.76):
